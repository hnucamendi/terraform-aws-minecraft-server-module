...
module "minecraft_server" {
  ...
  minecraft_world_seed   = "123456"
  minecraft_gamemode     = 1
...
| `ftb_modpack_version_id`              | `number`      | `0`                           | The version ID of the FTB modpack (only used if `isModpack` is `true`).                             |
...
| `minecraft_world_name`                | `string`      | `world`                       | Name of the Minecraft world.                                                                        |
| `minecraft_world_seed`                | `string`      | `""`                          | World seed for map generation.                                                                      |
| `minecraft_gamemode`                  | `number`      | `1`                           | Gamemode setting (0 = Survival, 1 = Creative, 2 = Adventure, 3 = Spectator).                        |
...
- If using an **FTB modpack**, set `ftb_modpack_id` and `ftb_modpack_version_id` accordingly.
